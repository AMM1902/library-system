 ...
 */
public class RegisterLibrarian extends BaseFrame implements ActionListener{
	...
	public RegisterLibrarian() {
		this.setTitle("Librarian Register ");
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(source==registerBtn) {
			// Performs the registration logic
			Connection conn=DB.connect();
			PreparedStatement pstmt;
			String sql;
			if(usertT.getText().isEmpty() || 
			emailT.getText().isEmpty() || 
			phonenoT.getText().isEmpty()|| 
			phonenoT.getText().isEmpty()) {
				...
				sql="INSERT INTO librarians (librarian_name, librarian_password, librarian_email, librarian_address, librarian_phone) VALUES(?, ?, ?, ?, ?)";
				try {
		...
		if(e.getSource() == showPwBox) {
			// Handles show password checkbox action
